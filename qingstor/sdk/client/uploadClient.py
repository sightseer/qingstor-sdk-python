...
class UploadClient:
    ...
    Attributes:
        ...
        part_num_list(int): the list of part index which hasn't yet uploaded (from class FileChunk)
        ...
        part_list: saving the part index which completes uploading
    ...
    def upload_large_file(self,file_name,file_path):
        ...
        file_chunk.part_num_list_init()
        #part_list stores the part number which completes uploading
        part_list=[]                
        while len(file_chunk.part_num_list):
            part_index=file_chunk.part_num_list[0]
            ...
            if output.status_code==self.status_part_created:
                ...
                file_chunk.part_num_list.pop(0)
        ...
        if len(file_chunk.part_num_list)==0:
